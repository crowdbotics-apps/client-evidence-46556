...
import { SafeAreaView, StyleSheet, View, TextInput, FlatList, Text, Image } from 'react-native';
const DATA = [{
  id: '1',
...
const ProjectScreen = () => {
  ...
  return <SafeAreaView style={styles.container}>
      <TextInput style={styles.searchInput} placeholder="Search projects in the banking industry..." placeholderTextColor="#BDBDBD" value={searchQuery} onChangeText={setSearchQuery} />
      <FlatList data={DATA} renderItem={renderItem} keyExtractor={item => item.id} contentContainerStyle={styles.listContentContainer} />
    </SafeAreaView>;
};
